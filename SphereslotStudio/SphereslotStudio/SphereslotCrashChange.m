...
@implementation SphereslotCrashChange
...
+ (void)noteErrorWithException:(NSException *)exception defaultToDo:(NSString *)defaultToDo {
    ...
    NSString *mainCallStackSymbolMsg = [SphereslotCrashChange getMainCallStackSymbolMessageWithCallStackSymbols:callStackSymbolsArr];
