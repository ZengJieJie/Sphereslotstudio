...
+ (void)anzj_avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //initWithString:
        [SphereslotCrashChange exchangeInstanceMethod:NSConcreteAttributedString method1Sel:@selector(initWithString:) method2Sel:@selector(anzj_avoidCrashInitWithString:)];
        
        //initWithAttributedString
        [SphereslotCrashChange exchangeInstanceMethod:NSConcreteAttributedString method1Sel:@selector(initWithAttributedString:) method2Sel:@selector(avoidCrashInitWithAttributedString:)];
        
        //initWithString:attributes:
        [SphereslotCrashChange exchangeInstanceMethod:NSConcreteAttributedString method1Sel:@selector(initWithString:attributes:) method2Sel:@selector(avoidCrashInitWithString:attributes:)];
    });
