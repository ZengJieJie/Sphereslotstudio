...
+ (void)anzj_avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [SphereslotCrashChange exchangeClassMethod:self method1Sel:@selector(dictionaryWithObjects:forKeys:count:) method2Sel:@selector(anzj_avoidCrashDictionaryWithObjects:forKeys:count:)];
    });
}
