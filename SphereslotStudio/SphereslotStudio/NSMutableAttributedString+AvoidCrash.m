...
+ (void)anzj_avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //initWithString:
        [SphereslotCrashChange exchangeInstanceMethod:NSConcreteMutableAttributedString method1Sel:@selector(initWithString:) method2Sel:@selector(anzj_avoidCrashInitWithString:)];
        
        //initWithString:attributes:
        [SphereslotCrashChange exchangeInstanceMethod:NSConcreteMutableAttributedString method1Sel:@selector(initWithString:attributes:) method2Sel:@selector(avoidCrashInitWithString:attributes:)];
    });
}
